...
//   );
// });
app.delete("/personaldetailsdeletebankdetails/:id",(req,res)=> {
  const id = req.params.id;
  dbpersonal.query("DELETE FROM bankdetails WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.delete("/personaldetailsdeleteemergencycontact/:id",(req,res)=> {
  const id = req.params.id;
  dbpersonal.query("DELETE FROM emergencycontact WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.delete("/personaldetailsdeleteinfogendetails/:id",(req,res)=> {
  const id = req.params.id;
  dbpersonal.query("DELETE FROM infogendetails WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.delete("/personaldetailsdeletepersonalinformation/:id",(req,res)=> {
  const id = req.params.id;
  dbpersonal.query("DELETE FROM personalinformation WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.delete("/leavedetailsdeleteapply/:id",(req,res)=> {
  const id = req.params.id;
  dbleave.query("DELETE FROM applyforregulaization WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.post("/employeedetailsdailytask", (req, res) => {
  ...
  dbemployee.query(
    "INSERT INTO dailytask (username,project,task,time,status,blockingissue,responsibleperson) VALUES (?,?,?,?,?,?,?)",
    [username, project, task, time, status, blockingissue, responsibleperson],
    (err, result) => {
      console.log(err);
    }
  );
...
app.delete("/employeedetailsdeleteemployeeappraisalform/:id",(req,res)=> {
  const id = req.params.id;
  dbemployee.query("DELETE FROM employeeappraisalform WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
...
app.post("/employeedetailsdailyattendance", (req, res) => {
  ...
  const status = req.body.status;
  dbemployee.query(
    "INSERT INTO dailyattendance (username,checkin,checkout,status) VALUES (?,?,?,?)",
    [username,checkin, checkout, status],
    (err, result) => {
      console.log(err);
    }
  );
...
app.delete("/employeedetailsdeletedailyattendance/:id",(req,res)=> {
  const id = req.params.id;
  dbemployee.query("DELETE FROM dailyattendance WHERE id=?",id,(err,result)=>{
    if(err){
      console.log(error);
    } else {
      res.send(result);
